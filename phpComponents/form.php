<form method="get" action="" class="main-form needs-validation" id="mainForm" novalidate >
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-check">
                                <input id="my-input" class="form-check-input" type="checkbox" name="vidaVal" value="1">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-check">
                                <input id="my-input" class="form-check-input" type="checkbox" name="casaVal" value="1">
                    ...
                    <div class="form-check">
                                <input id="my-input" class="form-check-input" type="checkbox" name="direitoInfoVal" value="1">
